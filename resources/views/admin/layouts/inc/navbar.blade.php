...
<nav class="main-header navbar navbar-expand text-sm {{config('lte3.view.dark_mode') ? 'dark-mode' : 'navbar-white navbar-light'}}">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{ auth()->user()->getFirstMediaUrl('image') }}" alt="User Avatar"
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-footer">
                        ...
                        <a href="{{ route('logout') }}" class="btn btn-default btn-flat float-right js-click-submit"
        ...
        @else
            <li class="nav-item">
                <a href="{{ route('logout') }}" class="nav-link js-click-submit" data-confirm="Logout?" role="button">
